...
class buildFormItem extends StatefulWidget {
  FormItem item;
  String? hintText;
  ...
  @override
  State<buildFormItem> createState() => _buildFormItemState();
}

class _buildFormItemState extends State<buildFormItem> {
  ...
  @override
  void didUpdateWidget(covariant buildFormItem oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (widget.item.type == FormItemType.radio && widget.item.op != null)
          Container(
            decoration: const BoxDecoration(
              border: Border(
                bottom: BorderSide(
                    ...
                    children: [
                      Theme(
                          ...
                          child: Radio<String>(
                            ...
                            value: op.val,
                            visualDensity: VisualDensity.compact, // 控制整体尺寸
            ...
            children: [
              Expanded(
                ...
                maxLength: widget.item.type == FormItemType.textarea
                    ? _maxLength
                    : null,
                maxLines: widget.item.type == FormItemType.textarea ? 5 : 1,
                minLines: widget.item.type == FormItemType.textarea ? 3 : 1,
                onTap: widget.onTap,
